define(function (require, exports, module) {
  module.exports = function (locals) {
    var buf = [];
    var locals_ = (locals || {}), rows = locals_.rows, userName = locals_.userName;
    jade.indent = [];
    ...
    (function () {
      ...
      if ('number' == typeof $$obj.length) {
        for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
          ...
          buf.push("\n    </select>\n  </td>\n  <td>" + (jade.escape(null == (jade.interp = row.teem) ? "" : jade.interp)) + "</td>\n  <td>" + (jade.escape(null == (jade.interp = 'More info...') ? "" : jade.interp)) + "</td>\n  <td>" + (jade.escape(null == (jade.interp = 'More info...') ? "" : jade.interp)) + "</td>\n  <td>" + (jade.escape(null == (jade.interp = 'More info...') ? "" : jade.interp)) + "</td>\n  <td class=\"edit\">");
          if (row.firstName == 'Lin') {
            buf.push("<a href=\"javascript:void(0);\">" + (jade.escape(null == (jade.interp = 'Edit') ? "" : jade.interp)) + "</a>");
          }else {
            buf.push("Eidt");
          }
          buf.push("\n  </td>\n</tr>");
